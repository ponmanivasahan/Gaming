        ...
        window.addEventListener('keydown',(event)=>{
          ...
          if(this.gameState.isPaused){
            if(event.key.toLowerCase()==='r'){
              ...
              this.gameState.showMatchStats=true;
              if(thiswindow.showMatchStats) window.showMatchStats();
            }
          ...
          switch(event.key){
            case 'd':
              ...
              case 'e':
                case 'E':
                  if(this.gameState.player && this.gameState.player.specialAttack){
                    this.gameState.player.specialAttack();
                  }
                  break;
                // case '1':
                //   if(this.gameState.useInventoryItem('shields')){
                //     this.gameState.activeItems.player.shield=true;
                //     if(window.showNotification) window.showNotification('Powerup used:Shield');
                //   }
                //   break;
